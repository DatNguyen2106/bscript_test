            ...
            if (role) {
                ...
                if (!id || typeof (id) === 'undefined') {
                ...
                } else {
                    {
                        ...
                        if (results.length === 0 || results === null || results === undefined || results === []) { res.send(results) }
                        else {
            ...
            if (role) {
                ...
                if (!id || typeof (id) === 'undefined') {
                ...
                } else {
                    {
                        ...
                        console.log(registrationBachelorThesisResults);
                        res.send(
            ...
            if (role) {
                {
                    ...
                    const results = await new Promise((resolve) => {
                        db.query(filterQuery, [thesisId, thesisTopic, lecturer1_id, lecturer2_id, slot, slotMaximum, lecturer1_title, lecturer2_title], (err, result) => {
                            if (err) { res.send(err); }
                            else {
                                console.log(filterQuery);
                                resolve(JSON.parse(JSON.stringify(result)))
                    ...
                    console.log(results.chunk(chunkForPage).length);
